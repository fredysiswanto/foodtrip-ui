...
export function Textarea({
  ...
  const baseStyles = 'w-full px-4 py-2 border rounded-lg font-normal text-gray-900 placeholder-gray-400 transition-colors duration-200 resize-none';
  ...
  return (
    <div className="w-full">
      ...
      <textarea rows={rows} className={finalClassName} disabled={disabled} {...props} />
